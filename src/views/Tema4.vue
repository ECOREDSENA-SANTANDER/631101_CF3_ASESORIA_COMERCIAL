      ...
      .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
        ...
        .row.justify-content-center.mb-4(data-aos="zoom-in-left")
          .col-lg-10.col-md-12.col-12.px-3
            ...
            img(src='@/assets/curso/temas/tema4/img05.svg', alt='la imagen presenta tres iconos donde se lee respectivamente lo siguiente: Descriptiva(bombillo): describir y comprender lo que está pasando. Big Data. Predictiva(lupa): predecir lo que puede pasar. Pronostico y simulación. Prescriptiva(grafica de barras): Lo que se debe hacer en el futuro. Técnicas de optimización.')
              ...
              .row.justify-content-center(titulo="Análisis del <i>Big Data</i>")
                ...
                .col-md-5.blanco.p-4
                  .titulo-sexto.color-secundario
                    h5 Figura 5.
                    |  Proceso business intelligence
                  img(src='@/assets/curso/temas/tema4/img09.png', alt='Texto alternativo: la imagen presenta las palabras BIG DATA en el medio de un circulo, sobre el cual se mencionan: recolección de datos, limpieza de datos, analisis de datos e interpretación de datos.')
